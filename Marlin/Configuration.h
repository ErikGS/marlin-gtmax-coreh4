...
#define STRING_CONFIG_H_AUTHOR "ErikGS" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "mixal3D Mod."
...
#define HEATER_1_MINTEMP -4
#define HEATER_2_MINTEMP -4
#define HEATER_3_MINTEMP -4
#define HEATER_4_MINTEMP -4
#define HEATER_5_MINTEMP -4
#define HEATER_6_MINTEMP -4
#define HEATER_7_MINTEMP -4
#define BED_MINTEMP -4
#define CHAMBER_MINTEMP -4
...
#define MPC_TUNING_POS       \
  {                          \
    X_CENTER, Y_CENTER, 0.3f \
  }                            // (mm) M306 Autotuning position, ideally bed center at first layer height.
#define MPC_TUNING_END_Z 440.0f // (mm) M306 Autotuning final Z position.
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE { 250, 250, 20, 60 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD
#if ENABLED(LIMITED_MAX_FR_EDITING)
#define MAX_FEEDRATE_EDIT_VALUES { 250, 250, 20, 60 }
#endif
...
#define MAX_ACCEL_EDIT_VALUES { 5000, 5000, 500, 5000 }
#endif
...
//
// See https://marlinfw.org/dmocs/configuration/probes.html
//
...
#define TOUCH_MI_RETRACT_Z -2 // Height at which the probe retracts
...
#define RACK_AND_PINION_PROBE
  ...
  #define Z_PROBE_RETRACT_X X_CENTER
  #define Z_PROBE_RETRACT_Y Y_CENTER
  #define TOUCH_MI_RETRACT_Z -1.5f
#endif
...
#define PROBE_DEPLOY_FEEDRATE (40 * 60) // (mm/min) Probe deploy speed
#define PROBE_STOW_FEEDRATE (20 * 60)   // (mm/min) Probe stow speed

#define MAG_MOUNTED_DEPLOY_1                \
  {                                         \
    PROBE_DEPLOY_FEEDRATE, { X_MIN_POS, 97.5, 50 } \
...
#define MAG_MOUNTED_STOW_1                \
  {                                       \
    PROBE_STOW_FEEDRATE, { 150, 97.5, 40 } \
  } // Move to dock
#define MAG_MOUNTED_STOW_2               \
  {                                      \
    PROBE_STOW_FEEDRATE, { 150, 97.5, -2 } \
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, 38, -5 }
...
#define Z_AFTER_HOMING 440 // (mm) Height to move to after homing Z
...
//#define MANUAL_PROBE_START_Z 0 // (mm) Comment out to use the last-measured height
#endif
...
#define BED_TRAMMING_HEIGHT 0.5 // (mm) Z height of nozzle at leveling points
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X50 Y50 F1800\nG1 Z0 F500"
...
#define HOMING_FEEDRATE_MM_M { (40 * 60), (40 * 60), (30 * 60) }
...
#define PREHEAT_1_TEMP_HOTEND 120
...
#define NOZZLE_PARK_POINT { (X_MIN_POS + 15), (Y_MIN_POS + 15), 30 }
...
#define LCD_FEEDBACK_FREQUENCY_HZ 3000
