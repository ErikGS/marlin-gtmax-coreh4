...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 10*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define FEEDRATE_CHANGE_BEEP_FREQUENCY 1000
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LCD_TIMEOUT_TO_STATUS 8000   // (ms)
  ...
  #define STATUS_MESSAGE_TIMEOUT_SEC 5 // (seconds)
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 16 // Direct Stepping/SD/LCD/Buttons takes more memory, so block buffer needs to be smaller
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 16 // SD/LCD/Buttons takes more memory, so block buffer needs to be smaller
#else
